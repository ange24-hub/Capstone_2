...
This document preserves the original readiness audit and pilot scope. Subsequent implementation added population/migration PDFs, assistant report links, and a local qwen2.5:1.5b writing pilot; see local-ai-operations.md for its setup, evaluation, and limits. Forecasting remains separate work. The standalone Behavioral Analysis feature has been removed; see behavioral-analysis.md.
