...
@foreach ($deceasedRecords as $record)
    ...
    <tr>
        ...
        <td><input form="{{ $rowForm }}" name="civil_status" value="{{ $record->civil_status }}"></td><td><input form="{{ $rowForm }}" name="education_level" value="{{ $record->education_level }}"></td><td><input form="{{ $rowForm }}" name="religion" value="{{ $record->religion }}"></td><td><input form="{{ $rowForm }}" name="occupation" value="{{ $record->occupation }}"></td><td><input form="{{ $rowForm }}" name="remarks" value="{{ \App\Support\RegistryRemarks::display($record->remarks) }}"></td><td><input form="{{ $rowForm }}" name="death_date" type="date" value="{{ optional($record->death_date)->format('Y-m-d') }}"></td>
