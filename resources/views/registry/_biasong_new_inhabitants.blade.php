...
<section class="new-family-form">
    ...
    <div class="table-wrap rbi-family-entry-table w-full overflow-x-auto rounded-xl border border-slate-200"><table>
