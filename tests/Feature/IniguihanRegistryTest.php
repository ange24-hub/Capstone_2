...
class IniguihanRegistryTest extends TestCase
{
    use RefreshDatabase;

    public function test_iniguihan_has_workbook_pages_and_can_save_monthly_families(): void
    {
        $barangay = Barangay::where('name', 'Iniguihan')->firstOrFail();
        $barangay->update(['secretary_name' => 'Iniguihan Secretary', 'punong_barangay_name' => 'Iniguihan Chair']);
        ...
        Inhabitant::create([
            ...
            'last_name' => 'Example', 'first_name' => 'IniguihanResident',
        ...
        $this->get(route('barangay.registry.active'))->assertOk()
            ->assertSee('INIGUIHAN')->assertSee('IniguihanResident')->assertSee('Not provided');
        ...
        $this->get(route('barangay.registry.new-inhabitants'))->assertOk()
            ->assertSee('INIGUIHAN')->assertSee('Save Monthly Report')
            ->assertSee('Iniguihan Secretary')->assertSee('Iniguihan Chair')
        ...
        $this->actingAs($otherSecretary)->get(route('barangay.registry.active'))
            ->assertOk()->assertDontSee('IniguihanResident');
